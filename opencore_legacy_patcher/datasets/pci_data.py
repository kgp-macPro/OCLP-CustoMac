...
class intel_wireless_ids:
    ...
    AirportItlwm = frozenset({
        ...
        0x2723, 0x43F0, 0xA0F0, 0x34F0, 0x4DF0, 0x02F0, 0x3DF0, 0x06F0,
        0x2720, 0x2725, 0x2726, 0x7A70, 0x7AF0, 0x51F0, 0x54F0, 0x2729,
        0x7E40, 0x7F70, 0x51F1,

        # iwm: Wireless-AC 3160/3165/3168, 7260/7265, 8260/8265,
        # 9260, 9461/9462 and 9560 families
        0x08B1, 0x08B2, 0x08B3, 0x08B4, 0x095A, 0x095B, 0x3165, 0x3166,
        0x24F3, 0x24F4, 0x24F5, 0x24F6, 0x24FB, 0x24FD, 0x2526, 0x9DF0,
        0xA370, 0x31DC, 0x30DC, 0x271C, 0x271B, 0x42A4, 0x00A0, 0x00A4,
        0x02A0, 0x40A4, 0x0060, 0x0064, 0x0260, 0x0264,

        # iwn: WiFi Link and Centrino Wireless-N families exposed by
        # AirportItlwm (0885/0886 are deliberately absent from its plist)
        0x4229, 0x422B, 0x422C, 0x4230, 0x4232, 0x4235, 0x4236, 0x4237,
        0x4238, 0x4239, 0x423A, 0x423B, 0x423C, 0x423D, 0x0082, 0x0083,
