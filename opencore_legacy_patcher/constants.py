...
class Constants:
    def __init__(self) -> None:
        ...
        self.root_patcher_patch_pending: bool = False  # Patch succeeded; reboot into the new snapshot is pending
        self.root_patcher_revert_pending: bool = False  # Revert selected; reboot required before state is clean
        self.root_patcher_pending_metadata: dict | None = None  # Session-only installed-operation evidence
